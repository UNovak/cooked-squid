...
Novak U. Primerjava algoritmov za reševanje problema usmerjanja kapacitetno omejenih vozil.\\
\noindent Univerza na Primorskem, Fakulteta za matematiko, naravoslovje in informacijske tehnologije, 2026}}
\chead[]{\fancyplain{}{}}
...
\vspace{6cm}
Zaključna naloga\\
\textbf{\large Primerjava algoritmov za reševanje problema usmerjanja kapacitetno omejenih vozil}\\
\normalsize
(Comparison of solution algorithms for the capacitated vehicle routing problem)\\
\end{center}

\begin{flushleft}
\vspace{5cm}
\noindent Ime in priimek: Urban Novak
...
\\
\noindent Mentor: dr. Balázs Dávid
